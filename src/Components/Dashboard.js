                ...
                <div className='dashboard-automate'>
                    ...
                    {autoSwitch?
                        <div className='auto'>
                            ...
                            {/*
                            <ul>
                                <BarChartItem title="06/28/24"></BarChartItem>
                                <BarChartItem title="06/27/24"></BarChartItem>
                                <BarChartItem title="06/26/24"></BarChartItem>
                                <BarChartItem title="06/25/24"></BarChartItem>
                            </ul>
